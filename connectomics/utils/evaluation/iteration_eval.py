...
def cal_infer(root_dir, model_id):
    ...
    command = "/home/chenzixuan/.conda/envs/vidar/bin/python {}connectomics/utils/evaluation/evaluate.py \
                 -gt \
                 /data/sjwlab/chenzx/code/MitoEM2021-Challenge/rat_val_gt.h5 \
                 -p \
...
if __name__=="__main__":
    """
    Please note 
    3. /opt/conda/bin/python need to change 
    1. Change the gt file! My gt file is in:
    /braindat/lab/limx/MitoEM2021/MitoEM-H/MitoEM-H/rat_val_gt.h5
    ...
    parser.add_argument('--root-path', type=str, default="/data/sjwlab/chenzx/code/MitoEM2021-Challenge", help='root dir path')
    parser.add_argument('--gt-path', type=str, default="/data/sjwlab/chenzx/code/MitoEM2021-Challenge/rat_val_gt.h5", help='root dir path')
